...
std::string SimpleWebUI::generateHTML() {
    ...
    html << "                    <div>θ: <span class=\"value\" id=\"lidar-theta\">0.00</span> rad</div>\n";
    html << "                </div>\n";
    html << "            </div>\n";
    html << "            \n";
    html << "            <div class=\"panel\">\n";
    ...
    html << "                    <div>θ: <span class=\"value\" id=\"odom-theta\">0.00</span> rad</div>\n";
    html << "                </div>\n";
    html << "            </div>\n";
    html << "            \n";
    html << "                        <div class=\"panel\">\n";
            ...
            html << "                    <div>θ: <span class=\"value\" id=\"robot-theta\">0.00</span> rad</div>\n";
            html << "                    <div>Cov XX: <span class=\"value\" id=\"cov-xx\">0.00</span></div>\n";
            html << "                    <div>Cov YY: <span class=\"value\" id=\"cov-yy\">0.00</span></div>\n";
            html << "                    <div>Cov θθ: <span class=\"value\" id=\"cov-tt\">0.00</span></div>\n";
            html << "                </div>\n";
            html << "            </div>\n";
    html << "        </div>\n";
    html << "        \n";
    ...
    html << "                .then(data => {\n";
        ...
        html << "                    document.getElementById('lidar-theta').textContent = data.lidar_theta.toFixed(2);\n";
        ...
        html << "                    document.getElementById('odom-theta').textContent = data.odom_theta.toFixed(2);\n";
        ...
        html << "                    document.getElementById('robot-theta').textContent = data.robot_theta.toFixed(2);\n";
    ...
    html << "        \n";
        ...
        html << "            });\n";
        html << "            \n";
        html << "            // Check if any movement button is pressed\n";
